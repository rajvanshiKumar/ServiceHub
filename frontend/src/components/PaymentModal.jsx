...
//     setLoading(true);
//     try {
//       const bypassTxn = `BYPASS${Date.now()}`;
//       await saveOrder(bypassTxn);
//       setSavedTxn(bypassTxn);
//       setStep('bypassed');
//     } catch (err) {
...
//       borderRadius: '12px', padding: '16px', textAlign: 'left', marginBottom: '22px',
//     }}>
//       {[
...
//           alignItems: 'flex-start', gap: '12px', padding: '8px 0',
...
//           }}>
//             <div style={{
//               width: '42px', height: '42px', borderRadius: '10px', backgroundColor: '#5382ff',
//               display: 'flex', alignItems: 'center', justifyContent: 'center',
...
//             <div style={{ color: '#8892a4', fontSize: '12px', marginBottom: '4px' }}>Pay exactly</div>
//             <div style={{ color: '#2dc653', fontWeight: '800', fontSize: '32px' }}>
//               {service.price}
//             </div>
//           </div>
//           <div style={{
...
//               <span style={{ color: '#666', fontSize: '12px' }}>Add QR to /public/phonepe-qr.png</span>
//             </div>
...
//             </div>
//             <button onClick={() => navigator.clipboard.writeText(UPI_ID)} style={{
...
//             />
//             {error && (
//               <p style={{ color: '#e94560', fontSize: '11px', margin: '4px 0 0' }}>⚠ {error}</p>
//             )}
...
//           </button>
//           <button style={btnSecondary} onClick={() => setStep('summary')}>← Back</button>
//         </div>
//       </div>
//     </div>
//   );
...
//   // ── BYPASSED ──────────────────────────────────────────────
//   if (step === 'bypassed') return (
//     <div style={overlayStyle}>
//       <div style={modalStyle} onClick={e => e.stopPropagation()}>
//         <div style={bodyStyle}>
//           <div style={{ textAlign: 'center', padding: '10px 0 20px' }}>
//             <div style={{ fontSize: '40px', letterSpacing: '8px', marginBottom: '6px' }}>
//               🎉✅🚀
//             </div>
//             <div style={{ fontSize: '32px', letterSpacing: '6px', marginBottom: '20px' }}>
//               💳🔓⚡
//             </div>
//             <h2 style={{ color: 'white', fontWeight: '800', fontSize: '22px', marginBottom: '6px' }}>
//               Payment Done!
//             </h2>
//             <p style={{ color: '#2dc653', fontWeight: '600', fontSize: '14px', marginBottom: '4px' }}>
//               Your service has been unlocked successfully.
//             </p>
//             <p style={{ color: '#8892a4', fontSize: '12px', marginBottom: '22px' }}>
//               Txn ID:{' '}
//               <span style={{ color: '#6c63ff', fontFamily: 'monospace', fontWeight: '700' }}>
//                 {savedTxn}
//               </span>
//             </p>
//             <Receipt />
...
//               View in Dashboard →
//             </button>
//             <button style={btnSecondary} onClick={onClose}>Continue Browsing</button>
//           </div>
//         </div>
//       </div>
//     </div>
...
//               marginBottom: '18px', boxShadow: '0 0 40px rgba(45,198,83,0.2)',
//             }}>✅</div>
//             <h2 style={{ color: 'white', fontWeight: '800', fontSize: '22px', marginBottom: '6px' }}>
//               Payment Confirmed!
//             </h2>
...
//               display: 'inline-flex', alignItems: 'center',
//               justifyContent: 'center', fontSize: '36px', marginBottom: '18px',
//             }}>❌</div>
...
export default function PaymentModal({ service, onClose }) {
  ...
  const bodyStyle = { padding: '28px 24px' };
        ...
        <div style={bodyStyle}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ color: '#8892a4', fontSize: '13px' }}>Amount</span>
              <span style={{ color: '#2dc653', fontWeight: '800', fontSize: '22px' }}>
                {service.price}
              </span>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div>
              <div style={{ color: '#2dc653', fontWeight: '700', fontSize: '13px' }}>
                Instant Access
              </div>
              <div style={{ color: '#8892a4', fontSize: '12px' }}>
                Service unlocked immediately after purchase
              </div>
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading}
          >
            {loading ? '⏳ Processing...' : `🛒 Buy Now — ${service.price}`}
          </button>
          <button style={btnSecondary} onClick={onClose}>Cancel</button>
        </div>
      </div>
  ...
  if (step === 'success') return (
    <div style={overlayStyle}>
      <div style={modalStyle} onClick={e => e.stopPropagation()}>
        <div style={bodyStyle}>
          <div style={{ textAlign: 'center', padding: '10px 0 20px' }}>
            <div style={{ fontSize: '44px', letterSpacing: '8px', marginBottom: '8px' }}>
              🎉✅🚀
            </div>
            <div style={{ fontSize: '34px', letterSpacing: '6px', marginBottom: '20px' }}>
              💳🔓⚡
            </div>
            <h2 style={{ color: 'white', fontWeight: '800', fontSize: '22px', marginBottom: '6px' }}>
              Payment Done!
            ...
            {/* Receipt */}
            <div style={{
              backgroundColor: 'rgba(45,198,83,0.06)',
              border: '1px solid rgba(45,198,83,0.2)',
              ...
              {[
                ...
                <div key={i} style={{
                  ...
                  <span style={{ color: '#8892a4', fontSize: '13px', flexShrink: 0 }}>
                    {row.l}
                  </span>
                  <span style={{
                    color: row.l === 'Status' ? '#2dc653' : 'white',
      ...
      <div style={modalStyle} onClick={e => e.stopPropagation()}>
        <div style={bodyStyle}>
          <div style={{ textAlign: 'center', padding: '10px 0 20px' }}>
            ...
            <button style={btnPrimary} onClick={() => { setStep('confirm'); setError(''); }}>
              Try Again
            </button>
            <button style={btnSecondary} onClick={onClose}>Cancel</button>
          </div>
